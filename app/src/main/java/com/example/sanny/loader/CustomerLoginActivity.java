    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    Intent intent=new Intent(CustomerLoginActivity.this, CutomerMenu_Activity.class);
        ...
        mLogin1 = (Button) findViewById(R.id.login);
        mregister1 = (Button) findViewById(R.id.register);
